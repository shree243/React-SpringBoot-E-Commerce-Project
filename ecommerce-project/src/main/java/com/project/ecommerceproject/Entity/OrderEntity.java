...
public class OrderEntity {
	...
	public OrderEntity(Long id, String orderId, User user, List<OrderItem> orderItems, LocalDateTime orderDate,
	...
	public void setDiscount(Integer discounte) {
	...
	public String toString() {
		return "Order [id=" + id + ", orderId=" + orderId + ", user=" + user + ", orderItems=" + orderItems
				...
				+ ", totalPrice=" + totalPrice + ", totalDiscountedPrice=" + totalDiscountedPrice + ", discounte="
				+ discount + ", totalItem=" + totalItem + ", createdAt=" + createdAt + "]";
	}
